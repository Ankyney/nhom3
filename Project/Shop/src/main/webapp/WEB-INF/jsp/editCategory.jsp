						...
						<div class="col-md-4 inputGroupContainer">
							<div class="input-group">
								<span class="input-group-addon"><i
								 ...
								 <input name="id" placeholder="Nhập id" value="${categories.id}" class="form-control" />
							</div>
						</div>
					</div>
					<br>
					...
					<div class="form-group">
						...
						<div class="col-md-4 inputGroupContainer">
							<div class="input-group">
								<span class="input-group-addon"><i
									class="glyphicon glyphicon-book"></i></span>
								<input name="name" placeholder="Nhập ma danh muc" value="${categories.name}" class="form-control"/>
							</div>
						</div>
					</div>
					<br>
