			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img
						src="static/admin/img/love.jpg" class="user-image"
						alt="User Image"> <span class="hidden-xs">${user.name}</span>
				</a>
					<ul class="dropdown-menu">
						<!-- User image -->
						<li class="user-header"><img
							src="static/admin/img/admin.png" class="img-circle"
							alt="User Image">
						...
						<li class="user-footer">
							<div class="pull-left">
								<a href="profileManager?user=${user.id}" class="btn btn-default btn-flat">Hồ Sơ</a>
							</div>
